        ...
        <Container maxWidth="md" sx={{ mt: 10, mb: 4 }}>
            <Card sx={{ background: 'rgba(255, 255, 255, 0.9)', backdropFilter: 'blur(10px)', borderRadius: 4, boxShadow: '0 8px 32px 0 rgba(31, 38, 135, 0.37)' }}>
                <CardContent sx={{ p: { xs: 2, sm: 4 } }}>
                    <Typography variant="h4" component="h1" gutterBottom textAlign="center" fontWeight="bold" color="primary.main" sx={{ mb: 4 }}>
                    ...
                    <Box component="form" onSubmit={handleSubmit} sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
                        ...
                        <TextField name="joinYear" type="number" label="Bạn tham gia nhóm vào năm?" fullWidth value={formData.joinYear} onChange={handleChange} required InputProps={{ startAdornment: renderIcon(<Event color="action"/>) }} />
